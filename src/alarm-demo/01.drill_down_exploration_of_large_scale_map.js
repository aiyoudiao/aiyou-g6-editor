...
import louvain from './01.drill_down_exploration_of_large_scale_map/louvain.js'

/* 引入demo数据 */
// import getData from "../demo/getData3"
// import getData from '../demo/getData4'
import getData from '../demo/getData5'
const model2 = getData()
...
const { labelPropagation, findShortestPath } = G6.Algorithm;
...
fetch('https://gw.alipayobjects.com/os/antvdemo/assets/data/relations.json')
        ...
        .then((data1) => {
            const data = {
                nodes: model2.graphData.nodes,
                edges: model2.graphData.edges
            }
            ...
            CANVAS_HEIGHT = (document.body.scrollHeight || 500) - 30;
