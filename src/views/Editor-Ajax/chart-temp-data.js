...
export default {
    ...
    chartList: [
        ...
        },
        {
            id: 'xxxx5',
            title: 'zjeb',
            img: require('@/assets/system-png/zjeb.png'),
            nodeLevel: 4,
            status: 'origin'
            // status: 'changed'
        },
        {
            id: 'xxxx6',
            title: 'zjibs',
            img: require('@/assets/system-png/zjibs.png'),
            nodeLevel: 4,
            status: 'origin'
            // status: 'changed'
        },
        {
            id: 'xxxx7',
            title: 'zjins',
            img: require('@/assets/system-png/zjins.png'),
            nodeLevel: 4,
            status: 'origin'
            // status: 'changed'
        },
        {
            id: 'xxxx8',
            title: 'zjtrs',
            img: require('@/assets/system-png/zjtrs.png'),
            nodeLevel: 4,
            status: 'origin'
            // status: 'changed'
        },
